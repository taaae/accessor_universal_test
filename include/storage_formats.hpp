...
AUT_DEFINE_BINARY_FORMAT(e0m4, 5, 0, true);
AUT_DEFINE_BINARY_FORMAT(e1m3, 5, 1, true);
AUT_DEFINE_BINARY_FORMAT(e2m2, 5, 2, false);
AUT_DEFINE_BINARY_FORMAT(e3m1, 5, 3, false);
AUT_DEFINE_BINARY_FORMAT(e4m0, 5, 4, false);

AUT_DEFINE_BINARY_FORMAT(e0m5, 6, 0, true);
AUT_DEFINE_BINARY_FORMAT(e1m4, 6, 1, true);
// CUDA FP6 encodings are finite-only and saturate out-of-range inputs.
AUT_DEFINE_BINARY_FORMAT(e2m3, 6, 2, true);
AUT_DEFINE_BINARY_FORMAT(e3m2, 6, 3, true);
AUT_DEFINE_BINARY_FORMAT(e4m1, 6, 4, false);
AUT_DEFINE_BINARY_FORMAT(e5m0, 6, 5, false);

AUT_DEFINE_BINARY_FORMAT(e0m6, 7, 0, true);
AUT_DEFINE_BINARY_FORMAT(e2m4, 7, 2, false);
AUT_DEFINE_BINARY_FORMAT(e3m3, 7, 3, false);
AUT_DEFINE_BINARY_FORMAT(e5m1, 7, 5, false);
AUT_DEFINE_BINARY_FORMAT(e6m0, 7, 6, false);
...
AUT_DEFINE_BINARY_FORMAT(e0m8, 9, 0, true);
AUT_DEFINE_BINARY_FORMAT(e2m6, 9, 2, false);
AUT_DEFINE_BINARY_FORMAT(e4m4, 9, 4, false);
AUT_DEFINE_BINARY_FORMAT(e5m3, 9, 5, false);
AUT_DEFINE_BINARY_FORMAT(e8m0, 9, 8, false);

AUT_DEFINE_BINARY_FORMAT(e2m7, 10, 2, false);
AUT_DEFINE_BINARY_FORMAT(e5m4, 10, 5, false);
AUT_DEFINE_BINARY_FORMAT(e8m1, 10, 8, false);

AUT_DEFINE_BINARY_FORMAT(e0m11, 12, 0, true);
...
AUT_DEFINE_BINARY_FORMAT(e2m14, 17, 2, false);
AUT_DEFINE_BINARY_FORMAT(e5m11, 17, 5, false);
AUT_DEFINE_BINARY_FORMAT(e8m8, 17, 8, false);

AUT_DEFINE_BINARY_FORMAT(e2m17, 20, 2, false);
...
AUT_DEFINE_BINARY_FORMAT(e2m25, 28, 2, false);
AUT_DEFINE_BINARY_FORMAT(e4m23, 28, 4, false);
AUT_DEFINE_BINARY_FORMAT(e5m22, 28, 5, false);
AUT_DEFINE_BINARY_FORMAT(e8m19, 28, 8, false);
...
struct e11m5 : fp64_prefix<5> {
  static constexpr const char *name = "e11m5";
};
...
struct e11m16 : fp64_prefix<16> {
  static constexpr const char *name = "e11m16";
};
...
AUT_INHERIT_BINARY_CODEC(e0m4);
AUT_INHERIT_BINARY_CODEC(e1m3);
AUT_INHERIT_BINARY_CODEC(e2m2);
AUT_INHERIT_BINARY_CODEC(e3m1);
AUT_INHERIT_BINARY_CODEC(e4m0);
AUT_INHERIT_BINARY_CODEC(e0m5);
AUT_INHERIT_BINARY_CODEC(e1m4);
AUT_INHERIT_BINARY_CODEC(e2m3);
AUT_INHERIT_BINARY_CODEC(e3m2);
AUT_INHERIT_BINARY_CODEC(e4m1);
AUT_INHERIT_BINARY_CODEC(e5m0);
AUT_INHERIT_BINARY_CODEC(e0m6);
AUT_INHERIT_BINARY_CODEC(e2m4);
AUT_INHERIT_BINARY_CODEC(e3m3);
AUT_INHERIT_BINARY_CODEC(e5m1);
AUT_INHERIT_BINARY_CODEC(e6m0);
AUT_INHERIT_BINARY_CODEC(e0m7);
AUT_INHERIT_BINARY_CODEC(e6m1);
AUT_INHERIT_BINARY_CODEC(e7m0);
AUT_INHERIT_BINARY_CODEC(e0m8);
AUT_INHERIT_BINARY_CODEC(e2m6);
AUT_INHERIT_BINARY_CODEC(e4m4);
AUT_INHERIT_BINARY_CODEC(e5m3);
AUT_INHERIT_BINARY_CODEC(e8m0);
AUT_INHERIT_BINARY_CODEC(e2m7);
AUT_INHERIT_BINARY_CODEC(e5m4);
AUT_INHERIT_BINARY_CODEC(e8m1);
AUT_INHERIT_BINARY_CODEC(e0m11);
...
AUT_INHERIT_BINARY_CODEC(e2m14);
AUT_INHERIT_BINARY_CODEC(e5m11);
AUT_INHERIT_BINARY_CODEC(e8m8);
...
AUT_INHERIT_BINARY_CODEC(e2m25);
AUT_INHERIT_BINARY_CODEC(e4m23);
AUT_INHERIT_BINARY_CODEC(e5m22);
AUT_INHERIT_BINARY_CODEC(e8m19);
...
template <> struct codec<e11m16> : prefix_codec<16> {};
